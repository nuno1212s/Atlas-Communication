...
pub fn serialize_message<W, RM, PM, CM>(w: &mut W, msg: &NetworkMessageKind<RM, PM, CM>) -> Result<()>
    where W: Write + AsRef<[u8]> + AsMut<[u8]>, RM: Serializable, PM: Serializable, CM: Serializable {
    #[cfg(feature = "serialize_capnp")]
...
pub fn deserialize_message<R, RM, PM, CM>(r: R) -> Result<NetworkMessageKind<RM, PM, CM>>
    where R: Read + AsRef<[u8]>, RM: Serializable + 'static, PM: Serializable + 'static, CM: Serializable + 'static {
    #[cfg(feature = "serialize_capnp")]
...
pub fn serialize_digest<W, RM, PM, CM>(message: &NetworkMessageKind<RM, PM, CM>, w: &mut W) -> Result<Digest>
    where W: Write + AsRef<[u8]> + AsMut<[u8]>, RM: Serializable, PM: Serializable, CM: Serializable {
